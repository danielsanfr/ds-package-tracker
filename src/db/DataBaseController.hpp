...
public:
	...
	Q_SIGNAL void tableNameChanged(const QString &tableName);
	Q_SIGNAL void createdRecord(const QString &tableName, const QVariantMap &data, const qlonglong &id);
	Q_SIGNAL void deletedRecord(const QString &tableName, const int &id);
	Q_SIGNAL void deletedRecord(const QString &tableName, const QVariantMap &arguments, const QString &conditions);
	Q_SIGNAL void updatedRecord(const QString &tableName, const QVariantMap &data);
private:
